...
def new_from_bounds(
    ...
    print("dest coordinates ", rows, cols)
    # TODO: possible to run into -1? better to error out i guess
    # TODO: will there be issues with the eps in rowcol???
