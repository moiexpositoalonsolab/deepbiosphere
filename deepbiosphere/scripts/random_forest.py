...
dset = dataset.Bioclim_Rasters_Point(paths.DBS_DIR, 'plant', 'cali', 'min_max', 'joint_multiple')
...
#         print(len(env_rasters))
        rebuilt[ind, i] = ras
        ind+=1
dframe = pd.DataFrame(rebuilt.T,index=np.arange(len(obs)), columns=['spec_id', 'bio_1', 'bio_2','bio_3','bio_4','bio_5', 'bio_6', 'bio_7','bio_8','bio_9','bio_10', 'bio_11', 'bio_12','bio_13','bio_14','bio_15','bio_16', 'bio_17','bio_18','bio_19','lat', 'lon'])
